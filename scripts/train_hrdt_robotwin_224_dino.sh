...
echo "🚀 Starting HRDT RobotWin training (224px)..."
echo "Project Root: $PROJECT_ROOT"
echo "Config: hrdt_robotwin_train.yaml"
echo ""

accelerate launch --main_process_port 29501 train_latent_motion_tokenizer.py \
  --config_path "${PROJECT_ROOT}/latent_motion_tokenizer/configs/train/hrdt_robotwin_dinov2_train.yaml"
